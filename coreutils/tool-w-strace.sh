...
TAR="coreutils-8.29.tar.xz"  # name of tar
LOC="coreutils-8.29"      # where project is untarred to

ORIGDIR=$(pwd)
ORIGPATH=$PATH

PREFIX_PATH="/data/home.local/sjspall/make-build-projects/coreutils/tmp/"
RESULTS_REPO="/data/home.local/sjspall/make-build-data" # this should exist already
RESULTS_DIR="${RESULTS_REPO}/coreutils"                       # will create this if it doesn't exist already
...
OUTFILE="${RESULTS_DIR}/${TAR_SHA}_${TIMESTAMP}/vim.buildinfo"
